  ...
  <div class="parentx">
    ...
    <vs-sidebar
      ...
      <div @mouseenter="mouseEnter" @mouseleave="mouseLeave">
        ...
        <!-- Header -->
        <div class="header-sidebar flex items-end justify-between bg-gray" slot="header">
          ...
          <div class="flex">
            ...
            <div>
            <div class="text-2xl vx-logo-text">Travel</div>
            <div class="text-2xl vx-logo-text text-primary">Pakistani</div>
            </div>
          </div>
        ...
        <!-- Menu Items -->
        <component :is="scrollbarTag" ref="verticalNavMenuPs" class="scroll-area-v-nav-menu pt-16 bg-gray" :settings="settings" @ps-scroll-y="psSectionScroll" @scroll="psSectionScroll" :key="$vs.rtl">
